...
import com.angoti.projetointegrador4_2020.activities.activitiesAddressUser.AlteracaoDeEnderecoDeUsuarioActivity
...
class EnderecoUserAdapter(private val dados: MutableList<AddressDTO>, val contexto: Context) :
    RecyclerView.Adapter<EnderecoUserAdapter.EnderecoViewHolder>() {
    ...
    //swipe
    private fun excluir() {
        (contexto as ListagemDeEnderecoDeUsuariosActivity).excluirEnderecoUsuario(mRecentlyDeletdItem!!.id)
    }
    ...
    inner class EnderecoViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView), View.OnClickListener {
        ...
        override fun onClick(v: View?) {
            ...
            val intent = Intent(contexto, AlteracaoDeEnderecoDeUsuarioActivity::class.java)
